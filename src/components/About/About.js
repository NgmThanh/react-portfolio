    ...
    <section id="about" className="about-section" data-scroll-section>
      ...
      <div className="about-grid">
        <div className="about-canvas">
          <img src={profilePicture} alt="profile illustration" className="about-image" data-scroll></img>
        </div>
        <div className="text font-white-grey col-4">Always in love with code and design, I like to learn new things every day and challenge myself with new projects, translating concepts into visual design. Always in love every day and challenge myself </div>
      </div>
      ...
      <div className="col-8 quote-container mb-80">
        ...
        <img src={lysFlower} alt="lys flower" className="lys-flower" data-scroll data-scroll-speed="1"></img>
      </div>
    </section>
  )
}