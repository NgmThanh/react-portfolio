  ...
  return (
    <section id="summary" className="summary-section">
      <div className="summary-title">
        ...
        <div className="side-title text-right">I create memorable<br></br><span className="font-gold">experiences</span></div>
      ...
      <div className="summary-1">
        ...
        <div className="col-5 mt-80">
          <h3 className="font-56 uppercase font-dark">Every great design begins with an even better story</h3>
          <p className="col-4 mt-80 font-20 font-dark">Always in love with code and design, i like to learn new things every day and challenge myself with new projects, translating concepts into visual design by paying close attention to details, and convert it into highly interactive experiences.</p>
        </div>
      </div>

      <div className="summary-2 mt-240">  
        <h3 className="font-56 uppercase font-dark col-6">Every great design begins with an even better story</h3>
