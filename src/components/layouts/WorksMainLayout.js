...
export default function WorksMainLayout() {
  ...
  return (
    <section id="works-main" className="main-works-section">
      <p className="side-title font-gold">Here is the</p>
      ...
      <div className="projects-grid">
        <div className="project-container project-right">
          ...
          <span className="project-title side-title font-bright">Self Branding</span>
        </div>
      ...
      <div className="mt-120 text-center uppercase-subtitle btn font-light"><span>Browse all projects</span></div>
    </section>
  )
}